...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators }) {
  ...
  return (
    ...
    >
      <motion.span
        variants={{
          inactive: { scale: 1, backgroundColor: "#eef5ff", color: "#005bff" },
          active: { scale: 1, backgroundColor: "#005bff", color: "#005bff" },
          complete: { scale: 1, backgroundColor: "#00c853", color: "#ffffff" }
        }}
...
function StepConnector({ isComplete }) {
  const lineVariants = {
    ...
    complete: { width: "100%", backgroundColor: "#00c853" }
  };
